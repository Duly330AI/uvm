...
**Hinweis:** Properties werden separat in *Portal_Properties_CRUD_and_Meters_1_1.md* spezifiziert. Django-Admin bleibt unverändert als „uncut Admin“.
...
* **Archived at** *(DateTime; nullable; **NEU per Migration**)*
* **Archived by** *(FK User; nullable; **NEU per Migration**)*
...
> **Nicht gefordert / kein Zwang:** keine globale Eindeutigkeit des *Unit label* (Unique-Regel kann später ergänzt werden).
...
* **Serial number** *(optional; max. 50; erlaubte Zeichen: A–Z, a–z, 0–9, `-`, `/`)*
* **Is default** *(Standardzähler; **max. 1 pro Unit+Medium**)*
* **Is active**
* **Initial reading value** *(optional; Decimal ≥ 0; wird **einmalig** als „vorheriger Stand" verwendet, falls noch kein Reading existiert)*
* **Installed at** *(Datum)*
* **Removed at** *(Datum; **≥ Installed at** oder leer)*
* **Notes** *(max. 1000)*
...
* Harte Validierung: pro *(Unit, Meter type)* **nur ein** `Is default = true`.
